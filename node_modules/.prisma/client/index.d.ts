...
/**
  ...
  /**
   * `prisma.sessionTime`: Exposes CRUD operations for the **SessionTime** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more SessionTimes
    * const sessionTimes = await prisma.sessionTime.findMany()
    * ```
    */
  get sessionTime(): Prisma.SessionTimeDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    sessionTime?: boolean | User$sessionTimeArgs
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'sessionTime' ? Array < SessionTimeGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'sessionTime' ? Array < SessionTimeGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    sessionTime<T extends User$sessionTimeArgs= {}>(args?: Subset<T, User$sessionTimeArgs>): Prisma.PrismaPromise<Array<SessionTimeGetPayload<T>>| Null>;
   ...
   * User.sessionTime
   */
  export type User$sessionTimeArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: SessionTimeInclude | null
    where?: SessionTimeWhereInput
    orderBy?: Enumerable<SessionTimeOrderByWithRelationInput>
    cursor?: SessionTimeWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<SessionTimeScalarFieldEnum>
  }
  ...
  export type AggregateSessionTime = {
    _count: SessionTimeCountAggregateOutputType | null
    _min: SessionTimeMinAggregateOutputType | null
    _max: SessionTimeMaxAggregateOutputType | null
  }

  export type SessionTimeMinAggregateOutputType = {
    id: string | null
    userId: string | null
    inTime: Date | null
    outTime: Date | null
  ...
  export type SessionTimeMaxAggregateOutputType = {
    id: string | null
    userId: string | null
    inTime: Date | null
    outTime: Date | null
  ...
  export type SessionTimeCountAggregateOutputType = {
    id: number
    userId: number
    inTime: number
    outTime: number
  ...
  export type SessionTimeMinAggregateInputType = {
    id?: true
    userId?: true
    inTime?: true
    outTime?: true
  ...
  export type SessionTimeMaxAggregateInputType = {
    id?: true
    userId?: true
    inTime?: true
    outTime?: true
  ...
  export type SessionTimeCountAggregateInputType = {
    id?: true
    userId?: true
    inTime?: true
    outTime?: true
  ...
  export type SessionTimeAggregateArgs = {
    /**
     * Filter which SessionTime to aggregate.
     */
    where?: SessionTimeWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of SessionTimes to fetch.
     */
    orderBy?: Enumerable<SessionTimeOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` SessionTimes from the position of the cursor.
     */
    take?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Skip the first `n` SessionTimes.
     */
    skip?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned SessionTimes
    **/
    _count?: true | SessionTimeCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: SessionTimeMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: SessionTimeMaxAggregateInputType
  }

  export type GetSessionTimeAggregateType<T extends SessionTimeAggregateArgs> = {
        [P in keyof T & keyof AggregateSessionTime]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateSessionTime[P]>
      : GetScalarType<T[P], AggregateSessionTime[P]>
  }
  ...
  export type SessionTimeGroupByArgs = {
    where?: SessionTimeWhereInput
    orderBy?: Enumerable<SessionTimeOrderByWithAggregationInput>
    by: SessionTimeScalarFieldEnum[]
    having?: SessionTimeScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: SessionTimeCountAggregateInputType | true
    _min?: SessionTimeMinAggregateInputType
    _max?: SessionTimeMaxAggregateInputType
  }


  export type SessionTimeGroupByOutputType = {
    id: string
    userId: string
    inTime: Date
    outTime: Date | null
  ...
  type GetSessionTimeGroupByPayload<T extends SessionTimeGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<SessionTimeGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof SessionTimeGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], SessionTimeGroupByOutputType[P]>
            : GetScalarType<T[P], SessionTimeGroupByOutputType[P]>
        }
      >
    >
  ...
  export type SessionTimeInclude = {
    user?: boolean | UserArgs
  }

  export type SessionTimeGetPayload<S extends boolean | null | undefined | SessionTimeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? SessionTime :
    S extends undefined ? never :
    S extends { include: any } & (SessionTimeArgs | SessionTimeFindManyArgs)
    ? SessionTime  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'user' ? UserGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (SessionTimeArgs | SessionTimeFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof SessionTime ? SessionTime[P] : never
  } 
      : SessionTime


  type SessionTimeCountArgs = 
    Omit<SessionTimeFindManyArgs, 'select' | 'include'> & {
      select?: SessionTimeCountAggregateInputType | true
    }

  export interface SessionTimeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {

    /**
     * Find zero or one SessionTime that matches the filter.
     * @param {SessionTimeFindUniqueArgs} args - Arguments to find a SessionTime
     * @example
     * // Get one SessionTime
     * const sessionTime = await prisma.sessionTime.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends SessionTimeFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, SessionTimeFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'SessionTime'> extends True ? Prisma__SessionTimeClient<SessionTimeGetPayload<T>> : Prisma__SessionTimeClient<SessionTimeGetPayload<T> | null, null>

    /**
     * Find one SessionTime that matches the filter or throw an error  with `error.code='P2025'` 
     *     if no matches were found.
     * @param {SessionTimeFindUniqueOrThrowArgs} args - Arguments to find a SessionTime
     * @example
     * // Get one SessionTime
     * const sessionTime = await prisma.sessionTime.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends SessionTimeFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, SessionTimeFindUniqueOrThrowArgs>
    ): Prisma__SessionTimeClient<SessionTimeGetPayload<T>>

    /**
     * Find the first SessionTime that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeFindFirstArgs} args - Arguments to find a SessionTime
     * @example
     * // Get one SessionTime
     * const sessionTime = await prisma.sessionTime.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends SessionTimeFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, SessionTimeFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'SessionTime'> extends True ? Prisma__SessionTimeClient<SessionTimeGetPayload<T>> : Prisma__SessionTimeClient<SessionTimeGetPayload<T> | null, null>

    /**
     * Find the first SessionTime that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeFindFirstOrThrowArgs} args - Arguments to find a SessionTime
     * @example
     * // Get one SessionTime
     * const sessionTime = await prisma.sessionTime.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends SessionTimeFindFirstOrThrowArgs>(
      args?: SelectSubset<T, SessionTimeFindFirstOrThrowArgs>
    ): Prisma__SessionTimeClient<SessionTimeGetPayload<T>>

    /**
     * Find zero or more SessionTimes that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all SessionTimes
     * const sessionTimes = await prisma.sessionTime.findMany()
     * 
     * // Get first 10 SessionTimes
     * const sessionTimes = await prisma.sessionTime.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const sessionTimeWithIdOnly = await prisma.sessionTime.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends SessionTimeFindManyArgs>(
      args?: SelectSubset<T, SessionTimeFindManyArgs>
    ): Prisma.PrismaPromise<Array<SessionTimeGetPayload<T>>>

    /**
     * Create a SessionTime.
     * @param {SessionTimeCreateArgs} args - Arguments to create a SessionTime.
     * @example
     * // Create one SessionTime
     * const SessionTime = await prisma.sessionTime.create({
     *   data: {
     *     // ... data to create a SessionTime
     *   }
     * })
     * 
    **/
    create<T extends SessionTimeCreateArgs>(
      args: SelectSubset<T, SessionTimeCreateArgs>
    ): Prisma__SessionTimeClient<SessionTimeGetPayload<T>>

    /**
     * Create many SessionTimes.
     *     @param {SessionTimeCreateManyArgs} args - Arguments to create many SessionTimes.
     *     @example
     *     // Create many SessionTimes
     *     const sessionTime = await prisma.sessionTime.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends SessionTimeCreateManyArgs>(
      args?: SelectSubset<T, SessionTimeCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Delete a SessionTime.
     * @param {SessionTimeDeleteArgs} args - Arguments to delete one SessionTime.
     * @example
     * // Delete one SessionTime
     * const SessionTime = await prisma.sessionTime.delete({
     *   where: {
     *     // ... filter to delete one SessionTime
     *   }
     * })
     * 
    **/
    delete<T extends SessionTimeDeleteArgs>(
      args: SelectSubset<T, SessionTimeDeleteArgs>
    ): Prisma__SessionTimeClient<SessionTimeGetPayload<T>>

    /**
     * Update one SessionTime.
     * @param {SessionTimeUpdateArgs} args - Arguments to update one SessionTime.
     * @example
     * // Update one SessionTime
     * const sessionTime = await prisma.sessionTime.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends SessionTimeUpdateArgs>(
      args: SelectSubset<T, SessionTimeUpdateArgs>
    ): Prisma__SessionTimeClient<SessionTimeGetPayload<T>>

    /**
     * Delete zero or more SessionTimes.
     * @param {SessionTimeDeleteManyArgs} args - Arguments to filter SessionTimes to delete.
     * @example
     * // Delete a few SessionTimes
     * const { count } = await prisma.sessionTime.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends SessionTimeDeleteManyArgs>(
      args?: SelectSubset<T, SessionTimeDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Update zero or more SessionTimes.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many SessionTimes
     * const sessionTime = await prisma.sessionTime.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends SessionTimeUpdateManyArgs>(
      args: SelectSubset<T, SessionTimeUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Create or update one SessionTime.
     * @param {SessionTimeUpsertArgs} args - Arguments to update or create a SessionTime.
     * @example
     * // Update or create a SessionTime
     * const sessionTime = await prisma.sessionTime.upsert({
     *   create: {
     *     // ... data to create a SessionTime
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the SessionTime we want to update
     *   }
     * })
    **/
    upsert<T extends SessionTimeUpsertArgs>(
      args: SelectSubset<T, SessionTimeUpsertArgs>
    ): Prisma__SessionTimeClient<SessionTimeGetPayload<T>>

    /**
     * Count the number of SessionTimes.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeCountArgs} args - Arguments to filter SessionTimes to count.
     * @example
     * // Count the number of SessionTimes
     * const count = await prisma.sessionTime.count({
     *   where: {
     *     // ... the filter for the SessionTimes we want to count
     *   }
     * })
    **/
    count<T extends SessionTimeCountArgs>(
      args?: Subset<T, SessionTimeCountArgs>,
    ): Prisma.PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], SessionTimeCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a SessionTime.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends SessionTimeAggregateArgs>(args: Subset<T, SessionTimeAggregateArgs>): Prisma.PrismaPromise<GetSessionTimeAggregateType<T>>

    /**
     * Group by SessionTime.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {SessionTimeGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends SessionTimeGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: SessionTimeGroupByArgs['orderBy'] }
        : { orderBy?: SessionTimeGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, SessionTimeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSessionTimeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>

  }

  /**
   * The delegate class that acts as a "Promise-like" for SessionTime.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__SessionTimeClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
  ...
  /**
   * SessionTime base type for findUnique actions
   */
  export type SessionTimeFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    ...
    include?: SessionTimeInclude | null
    /**
     * Filter, which SessionTime to fetch.
     */
    where: SessionTimeWhereUniqueInput
  }

  /**
   * SessionTime findUnique
   */
  export interface SessionTimeFindUniqueArgs extends SessionTimeFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * SessionTime findUniqueOrThrow
   */
  export type SessionTimeFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
  ...
  /**
   * SessionTime base type for findFirst actions
   */
  export type SessionTimeFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for SessionTimes.
     */
    cursor?: SessionTimeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of SessionTimes.
     */
    distinct?: Enumerable<SessionTimeScalarFieldEnum>
  }

  /**
   * SessionTime findFirst
   */
  export interface SessionTimeFindFirstArgs extends SessionTimeFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  /**
   * SessionTime findFirstOrThrow
   */
  export type SessionTimeFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
  ...
  /**
   * SessionTime findMany
   */
  export type SessionTimeFindManyArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    ...
    include?: SessionTimeInclude | null
    /**
     * Filter, which SessionTimes to fetch.
     */
    where?: SessionTimeWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing SessionTimes.
     */
    cursor?: SessionTimeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   ...
   * SessionTime create
   */
  export type SessionTimeCreateArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    ...
    include?: SessionTimeInclude | null
    /**
     * The data needed to create a SessionTime.
     */
    data: XOR<SessionTimeCreateInput, SessionTimeUncheckedCreateInput>
  }


  /**
   * SessionTime createMany
   */
  export type SessionTimeCreateManyArgs = {
    /**
     * The data used to create many SessionTimes.
     */
    data: Enumerable<SessionTimeCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * SessionTime update
   */
  export type SessionTimeUpdateArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    ...
    include?: SessionTimeInclude | null
    /**
     * The data needed to update a SessionTime.
     */
    data: XOR<SessionTimeUpdateInput, SessionTimeUncheckedUpdateInput>
    /**
     * Choose, which SessionTime to update.
     */
    where: SessionTimeWhereUniqueInput
  }
  ...
  /**
   * SessionTime updateMany
   */
  export type SessionTimeUpdateManyArgs = {
    /**
     * The data used to update SessionTimes.
     */
    data: XOR<SessionTimeUpdateManyMutationInput, SessionTimeUncheckedUpdateManyInput>
    /**
     * Filter which SessionTimes to update
     */
    where?: SessionTimeWhereInput
  }
   ...
   * SessionTime upsert
   */
  export type SessionTimeUpsertArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    ...
    include?: SessionTimeInclude | null
    /**
     * The filter to search for the SessionTime to update in case it exists.
     */
    where: SessionTimeWhereUniqueInput
    /**
     * In case the SessionTime found by the `where` argument doesn't exist, create a new SessionTime with this data.
     */
    create: XOR<SessionTimeCreateInput, SessionTimeUncheckedCreateInput>
    /**
     * In case the SessionTime was found with the provided `where` argument, update it with this data.
     */
    update: XOR<SessionTimeUpdateInput, SessionTimeUncheckedUpdateInput>
  }
   ...
   * SessionTime delete
   */
  export type SessionTimeDeleteArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
    ...
    include?: SessionTimeInclude | null
    /**
     * Filter which SessionTime to delete.
     */
    where: SessionTimeWhereUniqueInput
  }
  ...
  /**
   * SessionTime deleteMany
   */
  export type SessionTimeDeleteManyArgs = {
    /**
     * Filter which SessionTimes to delete
     */
    where?: SessionTimeWhereInput
  }
  ...
  /**
   * SessionTime without action
   */
  export type SessionTimeArgs = {
    /**
     * Select specific fields to fetch from the SessionTime
     */
    select?: SessionTimeSelect | null
  ...
  export const SessionTimeScalarFieldEnum: {
    id: 'id',
    userId: 'userId',
    inTime: 'inTime',
    outTime: 'outTime'
  ...
  export type SessionTimeScalarFieldEnum = (typeof SessionTimeScalarFieldEnum)[keyof typeof SessionTimeScalarFieldEnum]
  ...
  export type UserWhereInput = {
    ...
    sessionTime?: SessionTimeListRelationFilter
  }
  ...
  export type UserOrderByWithRelationInput = {
    ...
    sessionTime?: SessionTimeOrderByRelationAggregateInput
  }
  ...
  export type SessionTimeWhereInput = {
    AND?: Enumerable<SessionTimeWhereInput>
    OR?: Enumerable<SessionTimeWhereInput>
    NOT?: Enumerable<SessionTimeWhereInput>
    id?: StringFilter | string
    userId?: StringFilter | string
    inTime?: DateTimeFilter | Date | string
    outTime?: DateTimeNullableFilter | Date | string | null
    user?: XOR<UserRelationFilter, UserWhereInput>
  }

  export type SessionTimeOrderByWithRelationInput = {
    id?: SortOrder
    userId?: SortOrder
    inTime?: SortOrder
    outTime?: SortOrder
  ...
  export type SessionTimeWhereUniqueInput = {
    id?: string
  }

  export type SessionTimeOrderByWithAggregationInput = {
    id?: SortOrder
    userId?: SortOrder
    inTime?: SortOrder
    outTime?: SortOrder
    _count?: SessionTimeCountOrderByAggregateInput
    _max?: SessionTimeMaxOrderByAggregateInput
    _min?: SessionTimeMinOrderByAggregateInput
  }

  export type SessionTimeScalarWhereWithAggregatesInput = {
    AND?: Enumerable<SessionTimeScalarWhereWithAggregatesInput>
    OR?: Enumerable<SessionTimeScalarWhereWithAggregatesInput>
    NOT?: Enumerable<SessionTimeScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    userId?: StringWithAggregatesFilter | string
    inTime?: DateTimeWithAggregatesFilter | Date | string
    outTime?: DateTimeNullableWithAggregatesFilter | Date | string | null
  }
  ...
  export type UserCreateInput = {
    ...
    sessionTime?: SessionTimeCreateNestedManyWithoutUserInput
  }
  ...
  export type UserUncheckedCreateInput = {
    ...
    sessionTime?: SessionTimeUncheckedCreateNestedManyWithoutUserInput
  }
  ...
  export type UserUpdateInput = {
    ...
    sessionTime?: SessionTimeUpdateManyWithoutUserNestedInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    sessionTime?: SessionTimeUncheckedUpdateManyWithoutUserNestedInput
  }
  ...
  export type SessionTimeCreateInput = {
    id?: string
    inTime?: Date | string
    outTime?: Date | string | null
    user: UserCreateNestedOneWithoutSessionTimeInput
  }

  export type SessionTimeUncheckedCreateInput = {
    id?: string
    userId: string
    inTime?: Date | string
    outTime?: Date | string | null
  ...
  export type SessionTimeUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    user?: UserUpdateOneRequiredWithoutSessionTimeNestedInput
  }

  export type SessionTimeUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    userId?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  ...
  export type SessionTimeCreateManyInput = {
    id?: string
    userId: string
    inTime?: Date | string
    outTime?: Date | string | null
  ...
  export type SessionTimeUpdateManyMutationInput = {
    id?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  }

  export type SessionTimeUncheckedUpdateManyInput = {
    id?: StringFieldUpdateOperationsInput | string
    userId?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  ...
  export type SessionTimeListRelationFilter = {
    every?: SessionTimeWhereInput
    some?: SessionTimeWhereInput
    none?: SessionTimeWhereInput
  }
  ...
  export type SessionTimeOrderByRelationAggregateInput = {
    _count?: SortOrder
  }
  ...
  export type SessionTimeCountOrderByAggregateInput = {
    id?: SortOrder
    userId?: SortOrder
    inTime?: SortOrder
    outTime?: SortOrder
  ...
  export type SessionTimeMaxOrderByAggregateInput = {
    id?: SortOrder
    userId?: SortOrder
    inTime?: SortOrder
    outTime?: SortOrder
  ...
  export type SessionTimeMinOrderByAggregateInput = {
    id?: SortOrder
    userId?: SortOrder
    inTime?: SortOrder
    outTime?: SortOrder
  ...
  export type SessionTimeCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<SessionTimeCreateWithoutUserInput>, Enumerable<SessionTimeUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<SessionTimeCreateOrConnectWithoutUserInput>
    createMany?: SessionTimeCreateManyUserInputEnvelope
    connect?: Enumerable<SessionTimeWhereUniqueInput>
  }
  ...
  export type SessionTimeUncheckedCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<SessionTimeCreateWithoutUserInput>, Enumerable<SessionTimeUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<SessionTimeCreateOrConnectWithoutUserInput>
    createMany?: SessionTimeCreateManyUserInputEnvelope
    connect?: Enumerable<SessionTimeWhereUniqueInput>
  ...
  export type SessionTimeUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<SessionTimeCreateWithoutUserInput>, Enumerable<SessionTimeUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<SessionTimeCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<SessionTimeUpsertWithWhereUniqueWithoutUserInput>
    createMany?: SessionTimeCreateManyUserInputEnvelope
    set?: Enumerable<SessionTimeWhereUniqueInput>
    disconnect?: Enumerable<SessionTimeWhereUniqueInput>
    delete?: Enumerable<SessionTimeWhereUniqueInput>
    connect?: Enumerable<SessionTimeWhereUniqueInput>
    update?: Enumerable<SessionTimeUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<SessionTimeUpdateManyWithWhereWithoutUserInput>
    deleteMany?: Enumerable<SessionTimeScalarWhereInput>
  }
  ...
  export type SessionTimeUncheckedUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<SessionTimeCreateWithoutUserInput>, Enumerable<SessionTimeUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<SessionTimeCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<SessionTimeUpsertWithWhereUniqueWithoutUserInput>
    createMany?: SessionTimeCreateManyUserInputEnvelope
  ...
  export type UserCreateNestedOneWithoutSessionTimeInput = {
    create?: XOR<UserCreateWithoutSessionTimeInput, UserUncheckedCreateWithoutSessionTimeInput>
    connectOrCreate?: UserCreateOrConnectWithoutSessionTimeInput
    connect?: UserWhereUniqueInput
  }
  ...
  export type UserUpdateOneRequiredWithoutSessionTimeNestedInput = {
    create?: XOR<UserCreateWithoutSessionTimeInput, UserUncheckedCreateWithoutSessionTimeInput>
    connectOrCreate?: UserCreateOrConnectWithoutSessionTimeInput
    upsert?: UserUpsertWithoutSessionTimeInput
    connect?: UserWhereUniqueInput
    update?: XOR<UserUpdateWithoutSessionTimeInput, UserUncheckedUpdateWithoutSessionTimeInput>
  }
  ...
  export type SessionTimeCreateWithoutUserInput = {
    id?: string
    inTime?: Date | string
    outTime?: Date | string | null
  }

  export type SessionTimeUncheckedCreateWithoutUserInput = {
    id?: string
    inTime?: Date | string
    outTime?: Date | string | null
  }

  export type SessionTimeCreateOrConnectWithoutUserInput = {
    where: SessionTimeWhereUniqueInput
    create: XOR<SessionTimeCreateWithoutUserInput, SessionTimeUncheckedCreateWithoutUserInput>
  }

  export type SessionTimeCreateManyUserInputEnvelope = {
    data: Enumerable<SessionTimeCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type SessionTimeUpsertWithWhereUniqueWithoutUserInput = {
    where: SessionTimeWhereUniqueInput
    update: XOR<SessionTimeUpdateWithoutUserInput, SessionTimeUncheckedUpdateWithoutUserInput>
    create: XOR<SessionTimeCreateWithoutUserInput, SessionTimeUncheckedCreateWithoutUserInput>
  }

  export type SessionTimeUpdateWithWhereUniqueWithoutUserInput = {
    where: SessionTimeWhereUniqueInput
    data: XOR<SessionTimeUpdateWithoutUserInput, SessionTimeUncheckedUpdateWithoutUserInput>
  }

  export type SessionTimeUpdateManyWithWhereWithoutUserInput = {
    where: SessionTimeScalarWhereInput
    data: XOR<SessionTimeUpdateManyMutationInput, SessionTimeUncheckedUpdateManyWithoutSessionTimeInput>
  }

  export type SessionTimeScalarWhereInput = {
    AND?: Enumerable<SessionTimeScalarWhereInput>
    OR?: Enumerable<SessionTimeScalarWhereInput>
    NOT?: Enumerable<SessionTimeScalarWhereInput>
    id?: StringFilter | string
    userId?: StringFilter | string
    inTime?: DateTimeFilter | Date | string
    outTime?: DateTimeNullableFilter | Date | string | null
  ...
  export type UserCreateWithoutSessionTimeInput = {
    id?: string
    mobileNo: string
    firstName: string
    lastName: string
  ...
  export type UserUncheckedCreateWithoutSessionTimeInput = {
    id?: string
    mobileNo: string
    firstName: string
    lastName: string
  ...
  export type UserCreateOrConnectWithoutSessionTimeInput = {
    where: UserWhereUniqueInput
    create: XOR<UserCreateWithoutSessionTimeInput, UserUncheckedCreateWithoutSessionTimeInput>
  }

  export type UserUpsertWithoutSessionTimeInput = {
    update: XOR<UserUpdateWithoutSessionTimeInput, UserUncheckedUpdateWithoutSessionTimeInput>
    create: XOR<UserCreateWithoutSessionTimeInput, UserUncheckedCreateWithoutSessionTimeInput>
  }

  export type UserUpdateWithoutSessionTimeInput = {
    id?: StringFieldUpdateOperationsInput | string
    mobileNo?: StringFieldUpdateOperationsInput | string
    firstName?: StringFieldUpdateOperationsInput | string
    lastName?: StringFieldUpdateOperationsInput | string
  ...
  export type UserUncheckedUpdateWithoutSessionTimeInput = {
    id?: StringFieldUpdateOperationsInput | string
    mobileNo?: StringFieldUpdateOperationsInput | string
    firstName?: StringFieldUpdateOperationsInput | string
    lastName?: StringFieldUpdateOperationsInput | string
  ...
  export type SessionTimeCreateManyUserInput = {
    id?: string
    inTime?: Date | string
    outTime?: Date | string | null
  }
  ...
  export type SessionTimeUpdateWithoutUserInput = {
    id?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  }

  export type SessionTimeUncheckedUpdateWithoutUserInput = {
    id?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  }

  export type SessionTimeUncheckedUpdateManyWithoutSessionTimeInput = {
    id?: StringFieldUpdateOperationsInput | string
    inTime?: DateTimeFieldUpdateOperationsInput | Date | string
    outTime?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  }
