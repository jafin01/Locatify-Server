  ...
  */
  ...
  export type LocationGetPayload<S extends boolean | null | undefined | LocationArgs> =
    ...
    : S extends { select: any } & (LocationArgs | LocationFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> | null :  P extends keyof Location ? Location[P] : never
  } 
      : Location
  ...
  export type PlacesGetPayload<S extends boolean | null | undefined | PlacesArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'circle' ? CircleGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (PlacesArgs | PlacesFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> | null :
        P extends 'circle' ? CircleGetPayload<S['select'][P]> | null :  P extends keyof Places ? Places[P] : never
  } 
      : Places
  ...
  export type CircleMembersGetPayload<S extends boolean | null | undefined | CircleMembersArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'circle' ? CircleGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (CircleMembersArgs | CircleMembersFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'member' ? UserGetPayload<S['select'][P]> :
        P extends 'circle' ? CircleGetPayload<S['select'][P]> :  P extends keyof CircleMembers ? CircleMembers[P] : never
  } 
      : CircleMembers
  ...
  export type PlacesWhereInput = {
    ...
    user?: XOR<UserRelationFilter, UserWhereInput> | null
    circle?: XOR<CircleRelationFilter, CircleWhereInput> | null
  }
  ...
  export type CircleMembersWhereInput = {
    ...
    userId?: StringFilter | string
    circleId?: StringFilter | string
    role?: EnumMemberRoleFilter | MemberRole
  ...
  export type CircleMembersScalarWhereWithAggregatesInput = {
    ...
    userId?: StringWithAggregatesFilter | string
    circleId?: StringWithAggregatesFilter | string
    role?: EnumMemberRoleWithAggregatesFilter | MemberRole
  }
  ...
  export type PlacesUpdateInput = {
    ...
    circle?: CircleUpdateOneWithoutPlacesNestedInput
  }
  ...
  export type CircleMembersUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    role?: EnumMemberRoleFieldUpdateOperationsInput | MemberRole
  ...
  export type EnumMemberRoleFilter = {
    equals?: MemberRole
    in?: Enumerable<MemberRole>
    notIn?: Enumerable<MemberRole>
    not?: NestedEnumMemberRoleFilter | MemberRole
  }
  ...
  export type EnumMemberRoleWithAggregatesFilter = {
    equals?: MemberRole
    in?: Enumerable<MemberRole>
    notIn?: Enumerable<MemberRole>
    not?: NestedEnumMemberRoleWithAggregatesFilter | MemberRole
    _count?: NestedIntFilter
    _min?: NestedEnumMemberRoleFilter
    _max?: NestedEnumMemberRoleFilter
  }
  ...
  export type CircleUpdateOneWithoutPlacesNestedInput = {
    create?: XOR<CircleCreateWithoutPlacesInput, CircleUncheckedCreateWithoutPlacesInput>
    connectOrCreate?: CircleCreateOrConnectWithoutPlacesInput
  ...
  export type NestedEnumMemberRoleWithAggregatesFilter = {
    equals?: MemberRole
    in?: Enumerable<MemberRole>
    notIn?: Enumerable<MemberRole>
    not?: NestedEnumMemberRoleWithAggregatesFilter | MemberRole
